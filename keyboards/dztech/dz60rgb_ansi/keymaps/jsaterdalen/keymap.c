...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        _______,  _______, _______, _______, _______, _______, _______, _______, KC_UP,   _______, KC_PSCR, KC_SLCK, KC_PAUS, RESET,
        _______,  KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_HOME, KC_PGUP,          _______,
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, _______, RGB_SPI, RGB_SPD, _______, _______,          _______,
