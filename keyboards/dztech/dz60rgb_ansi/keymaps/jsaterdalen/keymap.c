...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI,                            KC_SPC,                             KC_RGUI, OSM(MOD_HYPR),   MO(2),   KC_RCTL
    ),
    [1] = LAYOUT_60_ansi(
        KC_GRAVE,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,           KC_F12,  KC_DEL,
        _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SLCT,          KC_PAUS, _______,
        _______,        KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, KC_PGUP,                   _______,
    ...
    [2] = LAYOUT_60_ansi(
        ...
        KC_CAPS, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, _______, RGB_SPI, RGB_SPD, _______, _______,          QK_BOOT,
